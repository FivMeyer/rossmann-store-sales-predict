...
class Rossmann(object):
    def __init__(self):
        self.home_path = '/home/fernando/Pyhton/Rossmann_Store_Sales_Predict'
    ...
    def feature_engineering(self, df2):
        ...
        # uma vez que foi filtrado a coluna open para apenas quando as lojas estivessem aberto agora eu posso remover ela do modelo pois não tem variabilidade nenhuma
